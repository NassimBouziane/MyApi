...
--
-- Host: localhost    Database: greento
-- ------------------------------------------------------
...
CREATE TABLE `category` (
  ...
  `steel` varchar(45) DEFAULT NULL,
  `glass` varchar(45) DEFAULT NULL,
  `plastic` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2022-10-17 16:23:10
